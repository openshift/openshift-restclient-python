...
from openshift.client.models.v1beta1_subject_access_review_spec import V1beta1SubjectAccessReviewSpec
...
class TestV1beta1SubjectAccessReviewSpec(unittest.TestCase):
    ...
    def testV1beta1SubjectAccessReviewSpec(self):
        ...
        """
        model = openshift.client.models.v1beta1_subject_access_review_spec.V1beta1SubjectAccessReviewSpec()
