...
from openshift.client.models.v1_stateful_set_status import V1StatefulSetStatus
...
class TestV1StatefulSetStatus(unittest.TestCase):
    ...
    def testV1StatefulSetStatus(self):
        ...
        #model = openshift.client.models.v1_stateful_set_status.V1StatefulSetStatus()
        pass
