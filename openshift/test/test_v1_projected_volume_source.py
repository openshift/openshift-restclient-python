...
from openshift.client.models.v1_projected_volume_source import V1ProjectedVolumeSource
...
class TestV1ProjectedVolumeSource(unittest.TestCase):
    ...
    def testV1ProjectedVolumeSource(self):
        ...
        """
        model = openshift.client.models.v1_projected_volume_source.V1ProjectedVolumeSource()
