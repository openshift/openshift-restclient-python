...
from openshift.client.models.v1beta1_deployment_condition import V1beta1DeploymentCondition
...
class TestV1beta1DeploymentCondition(unittest.TestCase):
    ...
    def testV1beta1DeploymentCondition(self):
        ...
        """
        model = openshift.client.models.v1beta1_deployment_condition.V1beta1DeploymentCondition()
