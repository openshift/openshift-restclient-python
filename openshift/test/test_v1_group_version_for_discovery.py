...
from openshift.client.models.v1_group_version_for_discovery import V1GroupVersionForDiscovery
...
class TestV1GroupVersionForDiscovery(unittest.TestCase):
    ...
    def testV1GroupVersionForDiscovery(self):
        ...
        """
        model = openshift.client.models.v1_group_version_for_discovery.V1GroupVersionForDiscovery()
