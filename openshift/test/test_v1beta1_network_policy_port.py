...
from openshift.client.models.v1beta1_network_policy_port import V1beta1NetworkPolicyPort
...
class TestV1beta1NetworkPolicyPort(unittest.TestCase):
    ...
    def testV1beta1NetworkPolicyPort(self):
        ...
        """
        model = openshift.client.models.v1beta1_network_policy_port.V1beta1NetworkPolicyPort()
