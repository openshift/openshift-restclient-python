...
from openshift.client.models.v1beta1_aggregation_rule import V1beta1AggregationRule
...
class TestV1beta1AggregationRule(unittest.TestCase):
    ...
    def testV1beta1AggregationRule(self):
        ...
        #model = openshift.client.models.v1beta1_aggregation_rule.V1beta1AggregationRule()
        pass
