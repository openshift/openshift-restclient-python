...
from openshift.client.models.v1beta1_fs_group_strategy_options import V1beta1FSGroupStrategyOptions
...
class TestV1beta1FSGroupStrategyOptions(unittest.TestCase):
    ...
    def testV1beta1FSGroupStrategyOptions(self):
        ...
        """
        model = openshift.client.models.v1beta1_fs_group_strategy_options.V1beta1FSGroupStrategyOptions()
