...
from openshift.client.models.v1_persistent_volume_status import V1PersistentVolumeStatus
...
class TestV1PersistentVolumeStatus(unittest.TestCase):
    ...
    def testV1PersistentVolumeStatus(self):
        ...
        """
        model = openshift.client.models.v1_persistent_volume_status.V1PersistentVolumeStatus()
