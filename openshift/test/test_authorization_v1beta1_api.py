...
from openshift.client.apis.authorization_v1beta1_api import AuthorizationV1beta1Api
...
class TestAuthorizationV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openshift.client.apis.authorization_v1beta1_api.AuthorizationV1beta1Api()
