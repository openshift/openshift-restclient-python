...
from openshift.client.models.v1beta1_token_review_status import V1beta1TokenReviewStatus
...
class TestV1beta1TokenReviewStatus(unittest.TestCase):
    ...
    def testV1beta1TokenReviewStatus(self):
        ...
        """
        model = openshift.client.models.v1beta1_token_review_status.V1beta1TokenReviewStatus()
