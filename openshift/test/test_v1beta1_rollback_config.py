...
from openshift.client.models.v1beta1_rollback_config import V1beta1RollbackConfig
...
class TestV1beta1RollbackConfig(unittest.TestCase):
    ...
    def testV1beta1RollbackConfig(self):
        ...
        """
        model = openshift.client.models.v1beta1_rollback_config.V1beta1RollbackConfig()
