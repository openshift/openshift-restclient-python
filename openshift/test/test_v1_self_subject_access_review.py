...
from openshift.client.models.v1_self_subject_access_review import V1SelfSubjectAccessReview
...
class TestV1SelfSubjectAccessReview(unittest.TestCase):
    ...
    def testV1SelfSubjectAccessReview(self):
        ...
        """
        model = openshift.client.models.v1_self_subject_access_review.V1SelfSubjectAccessReview()
