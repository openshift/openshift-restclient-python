...
from openshift.client.apis.admissionregistration_v1beta1_api import AdmissionregistrationV1beta1Api
...
class TestAdmissionregistrationV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openshift.client.apis.admissionregistration_v1beta1_api.AdmissionregistrationV1beta1Api()
