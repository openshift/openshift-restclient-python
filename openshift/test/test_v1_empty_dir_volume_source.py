...
from openshift.client.models.v1_empty_dir_volume_source import V1EmptyDirVolumeSource
...
class TestV1EmptyDirVolumeSource(unittest.TestCase):
    ...
    def testV1EmptyDirVolumeSource(self):
        ...
        """
        model = openshift.client.models.v1_empty_dir_volume_source.V1EmptyDirVolumeSource()
