...
from openshift.client.models.v1_secret_volume_source import V1SecretVolumeSource
...
class TestV1SecretVolumeSource(unittest.TestCase):
    ...
    def testV1SecretVolumeSource(self):
        ...
        """
        model = openshift.client.models.v1_secret_volume_source.V1SecretVolumeSource()
