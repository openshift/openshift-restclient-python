...
from openshift.client.models.v1beta1_certificate_signing_request_status import V1beta1CertificateSigningRequestStatus
...
class TestV1beta1CertificateSigningRequestStatus(unittest.TestCase):
    ...
    def testV1beta1CertificateSigningRequestStatus(self):
        ...
        """
        model = openshift.client.models.v1beta1_certificate_signing_request_status.V1beta1CertificateSigningRequestStatus()
