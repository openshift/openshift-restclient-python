...
from openshift.client.models.v1_component_condition import V1ComponentCondition
...
class TestV1ComponentCondition(unittest.TestCase):
    ...
    def testV1ComponentCondition(self):
        ...
        """
        model = openshift.client.models.v1_component_condition.V1ComponentCondition()
