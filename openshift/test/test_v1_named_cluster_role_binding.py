...
from openshift.client.models.v1_named_cluster_role_binding import V1NamedClusterRoleBinding
...
class TestV1NamedClusterRoleBinding(unittest.TestCase):
    ...
    def testV1NamedClusterRoleBinding(self):
        ...
        """
        model = openshift.client.models.v1_named_cluster_role_binding.V1NamedClusterRoleBinding()
