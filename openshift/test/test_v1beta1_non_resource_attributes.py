...
from openshift.client.models.v1beta1_non_resource_attributes import V1beta1NonResourceAttributes
...
class TestV1beta1NonResourceAttributes(unittest.TestCase):
    ...
    def testV1beta1NonResourceAttributes(self):
        ...
        """
        model = openshift.client.models.v1beta1_non_resource_attributes.V1beta1NonResourceAttributes()
