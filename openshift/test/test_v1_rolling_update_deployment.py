...
from openshift.client.models.v1_rolling_update_deployment import V1RollingUpdateDeployment
...
class TestV1RollingUpdateDeployment(unittest.TestCase):
    ...
    def testV1RollingUpdateDeployment(self):
        ...
        #model = openshift.client.models.v1_rolling_update_deployment.V1RollingUpdateDeployment()
        pass
