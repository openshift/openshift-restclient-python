...
from openshift.client.models.v1_subject_access_review_spec import V1SubjectAccessReviewSpec
...
class TestV1SubjectAccessReviewSpec(unittest.TestCase):
    ...
    def testV1SubjectAccessReviewSpec(self):
        ...
        """
        model = openshift.client.models.v1_subject_access_review_spec.V1SubjectAccessReviewSpec()
