...
from openshift.openshift.client.apis.autoscaling_v1_api import AutoscalingV1Api
...
class TestAutoscalingV1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openshift.openshift.client.apis.autoscaling_v1_api.AutoscalingV1Api()
