...
from openshift.client.models.v1_resource_quota_spec import V1ResourceQuotaSpec
...
class TestV1ResourceQuotaSpec(unittest.TestCase):
    ...
    def testV1ResourceQuotaSpec(self):
        ...
        """
        model = openshift.client.models.v1_resource_quota_spec.V1ResourceQuotaSpec()
