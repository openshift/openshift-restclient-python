...
from openshift.openshift.client.apis.batch_v2alpha1_api import BatchV2alpha1Api
...
class TestBatchV2alpha1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openshift.openshift.client.apis.batch_v2alpha1_api.BatchV2alpha1Api()

    def tearDown(self):
        pass

    def test_create_cron_job_for_all_namespaces(self):
        """
        Test case for create_cron_job_for_all_namespaces
    ...
    def test_create_scheduled_job_for_all_namespaces(self):
        """
        Test case for create_scheduled_job_for_all_namespaces
