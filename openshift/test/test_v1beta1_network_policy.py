...
from openshift.client.models.v1beta1_network_policy import V1beta1NetworkPolicy
...
class TestV1beta1NetworkPolicy(unittest.TestCase):
    ...
    def testV1beta1NetworkPolicy(self):
        ...
        """
        model = openshift.client.models.v1beta1_network_policy.V1beta1NetworkPolicy()
