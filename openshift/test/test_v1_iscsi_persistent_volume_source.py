...
from openshift.client.models.v1_iscsi_persistent_volume_source import V1ISCSIPersistentVolumeSource
...
class TestV1ISCSIPersistentVolumeSource(unittest.TestCase):
    ...
    def testV1ISCSIPersistentVolumeSource(self):
        ...
        #model = openshift.client.models.v1_iscsi_persistent_volume_source.V1ISCSIPersistentVolumeSource()
        pass
