...
from openshift.client.models.v1_replica_set_condition import V1ReplicaSetCondition
...
class TestV1ReplicaSetCondition(unittest.TestCase):
    ...
    def testV1ReplicaSetCondition(self):
        ...
        #model = openshift.client.models.v1_replica_set_condition.V1ReplicaSetCondition()
        pass
