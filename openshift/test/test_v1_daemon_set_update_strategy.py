...
from openshift.client.models.v1_daemon_set_update_strategy import V1DaemonSetUpdateStrategy
...
class TestV1DaemonSetUpdateStrategy(unittest.TestCase):
    ...
    def testV1DaemonSetUpdateStrategy(self):
        ...
        #model = openshift.client.models.v1_daemon_set_update_strategy.V1DaemonSetUpdateStrategy()
        pass
