...
from openshift.client.models.v1beta1_storage_class_list import V1beta1StorageClassList
...
class TestV1beta1StorageClassList(unittest.TestCase):
    ...
    def testV1beta1StorageClassList(self):
        ...
        """
        model = openshift.client.models.v1beta1_storage_class_list.V1beta1StorageClassList()
