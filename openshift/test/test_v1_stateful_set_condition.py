...
from openshift.client.models.v1_stateful_set_condition import V1StatefulSetCondition
...
class TestV1StatefulSetCondition(unittest.TestCase):
    ...
    def testV1StatefulSetCondition(self):
        ...
        #model = openshift.client.models.v1_stateful_set_condition.V1StatefulSetCondition()
        pass
