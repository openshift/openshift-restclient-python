...
from openshift.client.models.v1beta1_pod_disruption_budget import V1beta1PodDisruptionBudget
...
class TestV1beta1PodDisruptionBudget(unittest.TestCase):
    ...
    def testV1beta1PodDisruptionBudget(self):
        ...
        """
        model = openshift.client.models.v1beta1_pod_disruption_budget.V1beta1PodDisruptionBudget()
