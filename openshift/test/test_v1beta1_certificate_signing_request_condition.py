...
from openshift.client.models.v1beta1_certificate_signing_request_condition import V1beta1CertificateSigningRequestCondition
...
class TestV1beta1CertificateSigningRequestCondition(unittest.TestCase):
    ...
    def testV1beta1CertificateSigningRequestCondition(self):
        ...
        """
        model = openshift.client.models.v1beta1_certificate_signing_request_condition.V1beta1CertificateSigningRequestCondition()
