...
from openshift.openshift.client.apis.apps_v1beta1_api import AppsV1beta1Api
...
class TestAppsV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openshift.openshift.client.apis.apps_v1beta1_api.AppsV1beta1Api()

    def tearDown(self):
        pass

    def test_create_controller_revision_for_all_namespaces(self):
        """
        Test case for create_controller_revision_for_all_namespaces
    ...
    def test_create_stateful_set_for_all_namespaces(self):
        """
        Test case for create_stateful_set_for_all_namespaces
