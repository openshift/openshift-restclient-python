...
from openshift.client.models.unversioned_api_resource import UnversionedAPIResource
...
class TestUnversionedAPIResource(unittest.TestCase):
    ...
    def testUnversionedAPIResource(self):
        ...
        """
        model = openshift.client.models.unversioned_api_resource.UnversionedAPIResource()
