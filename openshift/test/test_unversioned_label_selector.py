...
from openshift.client.models.unversioned_label_selector import UnversionedLabelSelector
...
class TestUnversionedLabelSelector(unittest.TestCase):
    ...
    def testUnversionedLabelSelector(self):
        ...
        """
        model = openshift.client.models.unversioned_label_selector.UnversionedLabelSelector()
