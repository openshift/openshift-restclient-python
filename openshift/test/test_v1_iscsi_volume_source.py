...
from openshift.client.models.v1_iscsi_volume_source import V1ISCSIVolumeSource
...
class TestV1ISCSIVolumeSource(unittest.TestCase):
    ...
    def testV1ISCSIVolumeSource(self):
        ...
        """
        model = openshift.client.models.v1_iscsi_volume_source.V1ISCSIVolumeSource()
