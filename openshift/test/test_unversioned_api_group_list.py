...
from openshift.client.models.unversioned_api_group_list import UnversionedAPIGroupList
...
class TestUnversionedAPIGroupList(unittest.TestCase):
    ...
    def testUnversionedAPIGroupList(self):
        ...
        """
        model = openshift.client.models.unversioned_api_group_list.UnversionedAPIGroupList()
