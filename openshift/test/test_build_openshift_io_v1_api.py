...
from openshift.openshift.client.apis.build_openshift_io_v1_api import BuildOpenshiftIoV1Api
...
class TestBuildOpenshiftIoV1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openshift.openshift.client.apis.build_openshift_io_v1_api.BuildOpenshiftIoV1Api()
