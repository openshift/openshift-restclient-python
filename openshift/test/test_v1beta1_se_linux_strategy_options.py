...
from openshift.client.models.v1beta1_se_linux_strategy_options import V1beta1SELinuxStrategyOptions
...
class TestV1beta1SELinuxStrategyOptions(unittest.TestCase):
    ...
    def testV1beta1SELinuxStrategyOptions(self):
        ...
        """
        model = openshift.client.models.v1beta1_se_linux_strategy_options.V1beta1SELinuxStrategyOptions()
