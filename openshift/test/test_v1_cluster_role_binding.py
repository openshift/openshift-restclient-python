...
from openshift.client.models.v1_cluster_role_binding import V1ClusterRoleBinding
...
class TestV1ClusterRoleBinding(unittest.TestCase):
    ...
    def testV1ClusterRoleBinding(self):
        ...
        """
        model = openshift.client.models.v1_cluster_role_binding.V1ClusterRoleBinding()
