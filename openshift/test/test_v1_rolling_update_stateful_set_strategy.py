...
from openshift.client.models.v1_rolling_update_stateful_set_strategy import V1RollingUpdateStatefulSetStrategy
...
class TestV1RollingUpdateStatefulSetStrategy(unittest.TestCase):
    ...
    def testV1RollingUpdateStatefulSetStrategy(self):
        ...
        #model = openshift.client.models.v1_rolling_update_stateful_set_strategy.V1RollingUpdateStatefulSetStrategy()
        pass
