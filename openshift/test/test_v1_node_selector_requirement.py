...
from openshift.client.models.v1_node_selector_requirement import V1NodeSelectorRequirement
...
class TestV1NodeSelectorRequirement(unittest.TestCase):
    ...
    def testV1NodeSelectorRequirement(self):
        ...
        """
        model = openshift.client.models.v1_node_selector_requirement.V1NodeSelectorRequirement()
