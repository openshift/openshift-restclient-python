...
from openshift.client.models.v1_daemon_set_condition import V1DaemonSetCondition
...
class TestV1DaemonSetCondition(unittest.TestCase):
    ...
    def testV1DaemonSetCondition(self):
        ...
        #model = openshift.client.models.v1_daemon_set_condition.V1DaemonSetCondition()
        pass
