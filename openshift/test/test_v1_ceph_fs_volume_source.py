...
from openshift.client.models.v1_ceph_fs_volume_source import V1CephFSVolumeSource
...
class TestV1CephFSVolumeSource(unittest.TestCase):
    ...
    def testV1CephFSVolumeSource(self):
        ...
        """
        model = openshift.client.models.v1_ceph_fs_volume_source.V1CephFSVolumeSource()
