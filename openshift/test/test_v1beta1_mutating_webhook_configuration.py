...
from openshift.client.models.v1beta1_mutating_webhook_configuration import V1beta1MutatingWebhookConfiguration
...
class TestV1beta1MutatingWebhookConfiguration(unittest.TestCase):
    ...
    def testV1beta1MutatingWebhookConfiguration(self):
        ...
        #model = openshift.client.models.v1beta1_mutating_webhook_configuration.V1beta1MutatingWebhookConfiguration()
        pass
