...
from openshift.client.models.v1beta1_role_binding_list import V1beta1RoleBindingList
...
class TestV1beta1RoleBindingList(unittest.TestCase):
    ...
    def testV1beta1RoleBindingList(self):
        ...
        """
        model = openshift.client.models.v1beta1_role_binding_list.V1beta1RoleBindingList()
