...
from openshift.client.models.v1beta1_daemon_set_spec import V1beta1DaemonSetSpec
...
class TestV1beta1DaemonSetSpec(unittest.TestCase):
    ...
    def testV1beta1DaemonSetSpec(self):
        ...
        """
        model = openshift.client.models.v1beta1_daemon_set_spec.V1beta1DaemonSetSpec()
