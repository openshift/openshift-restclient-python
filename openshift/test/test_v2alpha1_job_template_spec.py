...
from openshift.client.models.v2alpha1_job_template_spec import V2alpha1JobTemplateSpec
...
class TestV2alpha1JobTemplateSpec(unittest.TestCase):
    ...
    def testV2alpha1JobTemplateSpec(self):
        ...
        """
        model = openshift.client.models.v2alpha1_job_template_spec.V2alpha1JobTemplateSpec()
