...
from openshift.client.models.v1_load_balancer_status import V1LoadBalancerStatus
...
class TestV1LoadBalancerStatus(unittest.TestCase):
    ...
    def testV1LoadBalancerStatus(self):
        ...
        """
        model = openshift.client.models.v1_load_balancer_status.V1LoadBalancerStatus()
