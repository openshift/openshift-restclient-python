...
from openshift.openshift.client.apis.apps_openshift_io_v1_api import AppsOpenshiftIoV1Api
...
class TestAppsOpenshiftIoV1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openshift.openshift.client.apis.apps_openshift_io_v1_api.AppsOpenshiftIoV1Api()
