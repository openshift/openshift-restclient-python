...
from openshift.client.models.v1_subject_access_review import V1SubjectAccessReview
...
class TestV1SubjectAccessReview(unittest.TestCase):
    ...
    def testV1SubjectAccessReview(self):
        ...
        """
        model = openshift.client.models.v1_subject_access_review.V1SubjectAccessReview()
