...
from openshift.client.models.v1_container_state_waiting import V1ContainerStateWaiting
...
class TestV1ContainerStateWaiting(unittest.TestCase):
    ...
    def testV1ContainerStateWaiting(self):
        ...
        """
        model = openshift.client.models.v1_container_state_waiting.V1ContainerStateWaiting()
