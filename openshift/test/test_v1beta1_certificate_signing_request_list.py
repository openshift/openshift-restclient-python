...
from openshift.client.models.v1beta1_certificate_signing_request_list import V1beta1CertificateSigningRequestList
...
class TestV1beta1CertificateSigningRequestList(unittest.TestCase):
    ...
    def testV1beta1CertificateSigningRequestList(self):
        ...
        """
        model = openshift.client.models.v1beta1_certificate_signing_request_list.V1beta1CertificateSigningRequestList()
