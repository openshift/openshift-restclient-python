...
from openshift.client.models.v1_config_map_env_source import V1ConfigMapEnvSource
...
class TestV1ConfigMapEnvSource(unittest.TestCase):
    ...
    def testV1ConfigMapEnvSource(self):
        ...
        """
        model = openshift.client.models.v1_config_map_env_source.V1ConfigMapEnvSource()
