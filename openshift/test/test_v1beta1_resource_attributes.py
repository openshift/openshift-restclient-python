...
from openshift.client.models.v1beta1_resource_attributes import V1beta1ResourceAttributes
...
class TestV1beta1ResourceAttributes(unittest.TestCase):
    ...
    def testV1beta1ResourceAttributes(self):
        ...
        """
        model = openshift.client.models.v1beta1_resource_attributes.V1beta1ResourceAttributes()
