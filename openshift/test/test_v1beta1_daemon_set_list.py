...
from openshift.client.models.v1beta1_daemon_set_list import V1beta1DaemonSetList
...
class TestV1beta1DaemonSetList(unittest.TestCase):
    ...
    def testV1beta1DaemonSetList(self):
        ...
        """
        model = openshift.client.models.v1beta1_daemon_set_list.V1beta1DaemonSetList()
