...
from openshift.client.models.v1_deprecated_downward_api_volume_file import V1DeprecatedDownwardAPIVolumeFile


class TestV1DeprecatedDownwardAPIVolumeFile(unittest.TestCase):
    """ V1DeprecatedDownwardAPIVolumeFile unit test stubs """
    ...
    def testV1DeprecatedDownwardAPIVolumeFile(self):
        """
        Test V1DeprecatedDownwardAPIVolumeFile
        """
        model = openshift.client.models.v1_deprecated_downward_api_volume_file.V1DeprecatedDownwardAPIVolumeFile()
