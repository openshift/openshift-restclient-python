...
from openshift.client.models.v1_self_subject_rules_review import V1SelfSubjectRulesReview
...
class TestV1SelfSubjectRulesReview(unittest.TestCase):
    ...
    def testV1SelfSubjectRulesReview(self):
        ...
        """
        model = openshift.client.models.v1_self_subject_rules_review.V1SelfSubjectRulesReview()
