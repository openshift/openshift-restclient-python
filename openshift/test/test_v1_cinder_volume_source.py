...
from openshift.client.models.v1_cinder_volume_source import V1CinderVolumeSource
...
class TestV1CinderVolumeSource(unittest.TestCase):
    ...
    def testV1CinderVolumeSource(self):
        ...
        """
        model = openshift.client.models.v1_cinder_volume_source.V1CinderVolumeSource()
