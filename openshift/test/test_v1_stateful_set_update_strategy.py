...
from openshift.client.models.v1_stateful_set_update_strategy import V1StatefulSetUpdateStrategy
...
class TestV1StatefulSetUpdateStrategy(unittest.TestCase):
    ...
    def testV1StatefulSetUpdateStrategy(self):
        ...
        #model = openshift.client.models.v1_stateful_set_update_strategy.V1StatefulSetUpdateStrategy()
        pass
