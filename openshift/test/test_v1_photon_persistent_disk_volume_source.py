...
from openshift.client.models.v1_photon_persistent_disk_volume_source import V1PhotonPersistentDiskVolumeSource
...
class TestV1PhotonPersistentDiskVolumeSource(unittest.TestCase):
    ...
    def testV1PhotonPersistentDiskVolumeSource(self):
        ...
        """
        model = openshift.client.models.v1_photon_persistent_disk_volume_source.V1PhotonPersistentDiskVolumeSource()
