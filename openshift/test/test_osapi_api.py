...
from openshift.client.apis.osapi_api import OsapiApi
...
class TestOsapiApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openshift.client.apis.osapi_api.OsapiApi()

    def tearDown(self):
        pass

    def test_get_osapi_version(self):
        """
        Test case for get_osapi_version
