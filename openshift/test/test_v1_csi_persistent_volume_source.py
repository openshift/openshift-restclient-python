...
from openshift.client.models.v1_csi_persistent_volume_source import V1CSIPersistentVolumeSource
...
class TestV1CSIPersistentVolumeSource(unittest.TestCase):
    ...
    def testV1CSIPersistentVolumeSource(self):
        ...
        #model = openshift.client.models.v1_csi_persistent_volume_source.V1CSIPersistentVolumeSource()
        pass
