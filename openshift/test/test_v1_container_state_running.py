...
from openshift.client.models.v1_container_state_running import V1ContainerStateRunning
...
class TestV1ContainerStateRunning(unittest.TestCase):
    ...
    def testV1ContainerStateRunning(self):
        ...
        """
        model = openshift.client.models.v1_container_state_running.V1ContainerStateRunning()
