...
from openshift.client.models.v1beta1_http_ingress_path import V1beta1HTTPIngressPath
...
class TestV1beta1HTTPIngressPath(unittest.TestCase):
    ...
    def testV1beta1HTTPIngressPath(self):
        ...
        """
        model = openshift.client.models.v1beta1_http_ingress_path.V1beta1HTTPIngressPath()
