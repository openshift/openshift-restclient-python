...
from openshift.client.models.v1beta1_deployment_strategy import V1beta1DeploymentStrategy
...
class TestV1beta1DeploymentStrategy(unittest.TestCase):
    ...
    def testV1beta1DeploymentStrategy(self):
        ...
        """
        model = openshift.client.models.v1beta1_deployment_strategy.V1beta1DeploymentStrategy()
