...
from openshift.client.models.v1_azure_disk_volume_source import V1AzureDiskVolumeSource
...
class TestV1AzureDiskVolumeSource(unittest.TestCase):
    ...
    def testV1AzureDiskVolumeSource(self):
        ...
        """
        model = openshift.client.models.v1_azure_disk_volume_source.V1AzureDiskVolumeSource()
