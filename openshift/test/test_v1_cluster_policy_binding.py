...
from openshift.client.models.v1_cluster_policy_binding import V1ClusterPolicyBinding
...
class TestV1ClusterPolicyBinding(unittest.TestCase):
    ...
    def testV1ClusterPolicyBinding(self):
        ...
        """
        model = openshift.client.models.v1_cluster_policy_binding.V1ClusterPolicyBinding()
