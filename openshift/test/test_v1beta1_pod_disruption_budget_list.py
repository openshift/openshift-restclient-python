...
from openshift.client.models.v1beta1_pod_disruption_budget_list import V1beta1PodDisruptionBudgetList
...
class TestV1beta1PodDisruptionBudgetList(unittest.TestCase):
    ...
    def testV1beta1PodDisruptionBudgetList(self):
        ...
        """
        model = openshift.client.models.v1beta1_pod_disruption_budget_list.V1beta1PodDisruptionBudgetList()
