...
from openshift.client.models.v1_service_account_list import V1ServiceAccountList
...
class TestV1ServiceAccountList(unittest.TestCase):
    ...
    def testV1ServiceAccountList(self):
        ...
        """
        model = openshift.client.models.v1_service_account_list.V1ServiceAccountList()
