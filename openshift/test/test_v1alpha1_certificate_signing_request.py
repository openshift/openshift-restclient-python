...
from openshift.client.models.v1alpha1_certificate_signing_request import V1alpha1CertificateSigningRequest
...
class TestV1alpha1CertificateSigningRequest(unittest.TestCase):
    ...
    def testV1alpha1CertificateSigningRequest(self):
        ...
        """
        model = openshift.client.models.v1alpha1_certificate_signing_request.V1alpha1CertificateSigningRequest()
