...
from openshift.client.models.v1beta1_allowed_flex_volume import V1beta1AllowedFlexVolume
...
class TestV1beta1AllowedFlexVolume(unittest.TestCase):
    ...
    def testV1beta1AllowedFlexVolume(self):
        ...
        #model = openshift.client.models.v1beta1_allowed_flex_volume.V1beta1AllowedFlexVolume()
        pass
