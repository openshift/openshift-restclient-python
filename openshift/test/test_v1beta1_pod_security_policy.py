...
from openshift.client.models.v1beta1_pod_security_policy import V1beta1PodSecurityPolicy
...
class TestV1beta1PodSecurityPolicy(unittest.TestCase):
    ...
    def testV1beta1PodSecurityPolicy(self):
        ...
        """
        model = openshift.client.models.v1beta1_pod_security_policy.V1beta1PodSecurityPolicy()
