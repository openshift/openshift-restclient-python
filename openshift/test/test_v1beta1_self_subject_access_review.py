...
from openshift.client.models.v1beta1_self_subject_access_review import V1beta1SelfSubjectAccessReview
...
class TestV1beta1SelfSubjectAccessReview(unittest.TestCase):
    ...
    def testV1beta1SelfSubjectAccessReview(self):
        ...
        """
        model = openshift.client.models.v1beta1_self_subject_access_review.V1beta1SelfSubjectAccessReview()
