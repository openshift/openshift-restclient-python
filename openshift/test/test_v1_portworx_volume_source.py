...
from openshift.client.models.v1_portworx_volume_source import V1PortworxVolumeSource
...
class TestV1PortworxVolumeSource(unittest.TestCase):
    ...
    def testV1PortworxVolumeSource(self):
        ...
        """
        model = openshift.client.models.v1_portworx_volume_source.V1PortworxVolumeSource()
