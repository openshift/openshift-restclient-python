...
from openshift.client.models.v1_cluster_role_binding_list import V1ClusterRoleBindingList
...
class TestV1ClusterRoleBindingList(unittest.TestCase):
    ...
    def testV1ClusterRoleBindingList(self):
        ...
        """
        model = openshift.client.models.v1_cluster_role_binding_list.V1ClusterRoleBindingList()
