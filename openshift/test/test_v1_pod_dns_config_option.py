...
from openshift.client.models.v1_pod_dns_config_option import V1PodDNSConfigOption
...
class TestV1PodDNSConfigOption(unittest.TestCase):
    ...
    def testV1PodDNSConfigOption(self):
        ...
        #model = openshift.client.models.v1_pod_dns_config_option.V1PodDNSConfigOption()
        pass
