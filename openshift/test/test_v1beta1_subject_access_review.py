...
from openshift.client.models.v1beta1_subject_access_review import V1beta1SubjectAccessReview
...
class TestV1beta1SubjectAccessReview(unittest.TestCase):
    ...
    def testV1beta1SubjectAccessReview(self):
        ...
        """
        model = openshift.client.models.v1beta1_subject_access_review.V1beta1SubjectAccessReview()
