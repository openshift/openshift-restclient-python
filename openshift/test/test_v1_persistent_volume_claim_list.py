...
from openshift.client.models.v1_persistent_volume_claim_list import V1PersistentVolumeClaimList
...
class TestV1PersistentVolumeClaimList(unittest.TestCase):
    ...
    def testV1PersistentVolumeClaimList(self):
        ...
        """
        model = openshift.client.models.v1_persistent_volume_claim_list.V1PersistentVolumeClaimList()
