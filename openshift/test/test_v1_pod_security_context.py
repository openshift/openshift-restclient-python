...
from openshift.client.models.v1_pod_security_context import V1PodSecurityContext
...
class TestV1PodSecurityContext(unittest.TestCase):
    ...
    def testV1PodSecurityContext(self):
        ...
        """
        model = openshift.client.models.v1_pod_security_context.V1PodSecurityContext()
