...
from openshift.client.models.v1beta1_daemon_set_update_strategy import V1beta1DaemonSetUpdateStrategy
...
class TestV1beta1DaemonSetUpdateStrategy(unittest.TestCase):
    ...
    def testV1beta1DaemonSetUpdateStrategy(self):
        ...
        """
        model = openshift.client.models.v1beta1_daemon_set_update_strategy.V1beta1DaemonSetUpdateStrategy()
