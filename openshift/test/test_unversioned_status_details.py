...
from openshift.client.models.unversioned_status_details import UnversionedStatusDetails
...
class TestUnversionedStatusDetails(unittest.TestCase):
    ...
    def testUnversionedStatusDetails(self):
        ...
        """
        model = openshift.client.models.unversioned_status_details.UnversionedStatusDetails()
