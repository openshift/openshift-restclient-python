...
from openshift.client.models.v2alpha1_cron_job_status import V2alpha1CronJobStatus
...
class TestV2alpha1CronJobStatus(unittest.TestCase):
    ...
    def testV2alpha1CronJobStatus(self):
        ...
        """
        model = openshift.client.models.v2alpha1_cron_job_status.V2alpha1CronJobStatus()
