...
from openshift.client.models.v1beta1_pod_security_policy_list import V1beta1PodSecurityPolicyList
...
class TestV1beta1PodSecurityPolicyList(unittest.TestCase):
    ...
    def testV1beta1PodSecurityPolicyList(self):
        ...
        """
        model = openshift.client.models.v1beta1_pod_security_policy_list.V1beta1PodSecurityPolicyList()
