...
from openshift.client.models.v1beta1_deployment_spec import V1beta1DeploymentSpec
...
class TestV1beta1DeploymentSpec(unittest.TestCase):
    ...
    def testV1beta1DeploymentSpec(self):
        ...
        """
        model = openshift.client.models.v1beta1_deployment_spec.V1beta1DeploymentSpec()
