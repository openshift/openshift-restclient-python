...
from openshift.client.models.v1beta1_subresource_reference import V1beta1SubresourceReference
...
class TestV1beta1SubresourceReference(unittest.TestCase):
    ...
    def testV1beta1SubresourceReference(self):
        ...
        """
        model = openshift.client.models.v1beta1_subresource_reference.V1beta1SubresourceReference()
