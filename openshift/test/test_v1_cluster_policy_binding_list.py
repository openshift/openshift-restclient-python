...
from openshift.client.models.v1_cluster_policy_binding_list import V1ClusterPolicyBindingList
...
class TestV1ClusterPolicyBindingList(unittest.TestCase):
    ...
    def testV1ClusterPolicyBindingList(self):
        ...
        """
        model = openshift.client.models.v1_cluster_policy_binding_list.V1ClusterPolicyBindingList()
