...
from openshift.client.models.v1_replication_controller import V1ReplicationController
...
class TestV1ReplicationController(unittest.TestCase):
    ...
    def testV1ReplicationController(self):
        ...
        """
        model = openshift.client.models.v1_replication_controller.V1ReplicationController()
