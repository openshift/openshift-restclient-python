...
from openshift.client.models.v1_scale_io_volume_source import V1ScaleIOVolumeSource
...
class TestV1ScaleIOVolumeSource(unittest.TestCase):
    ...
    def testV1ScaleIOVolumeSource(self):
        ...
        """
        model = openshift.client.models.v1_scale_io_volume_source.V1ScaleIOVolumeSource()
