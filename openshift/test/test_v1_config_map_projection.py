...
from openshift.client.models.v1_config_map_projection import V1ConfigMapProjection
...
class TestV1ConfigMapProjection(unittest.TestCase):
    ...
    def testV1ConfigMapProjection(self):
        ...
        """
        model = openshift.client.models.v1_config_map_projection.V1ConfigMapProjection()
