...
from openshift.client.models.v1_token_review_status import V1TokenReviewStatus
...
class TestV1TokenReviewStatus(unittest.TestCase):
    ...
    def testV1TokenReviewStatus(self):
        ...
        """
        model = openshift.client.models.v1_token_review_status.V1TokenReviewStatus()
