...
from openshift.client.models.unversioned_api_versions import UnversionedAPIVersions
...
class TestUnversionedAPIVersions(unittest.TestCase):
    ...
    def testUnversionedAPIVersions(self):
        ...
        """
        model = openshift.client.models.unversioned_api_versions.UnversionedAPIVersions()
