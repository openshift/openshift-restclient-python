...
from openshift.client.apis.authentication_v1beta1_api import AuthenticationV1beta1Api
...
class TestAuthenticationV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openshift.client.apis.authentication_v1beta1_api.AuthenticationV1beta1Api()
