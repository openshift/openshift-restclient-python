...
from openshift.client.apis.image_openshift_io_0_api import ImageOpenshiftIo0Api


class TestImageOpenshiftIo0Api(unittest.TestCase):
    """ ImageOpenshiftIo0Api unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.image_openshift_io_0_api.ImageOpenshiftIo0Api()

    def tearDown(self):
        pass

    def test_get_image_openshift_io0_api_resources(self):
        """
        Test case for get_image_openshift_io0_api_resources
