...
from openshift.client.models.v1_subject_rules_review_status import V1SubjectRulesReviewStatus
...
class TestV1SubjectRulesReviewStatus(unittest.TestCase):
    ...
    def testV1SubjectRulesReviewStatus(self):
        ...
        """
        model = openshift.client.models.v1_subject_rules_review_status.V1SubjectRulesReviewStatus()
