...
from openshift.client.models.v1_node_daemon_endpoints import V1NodeDaemonEndpoints
...
class TestV1NodeDaemonEndpoints(unittest.TestCase):
    ...
    def testV1NodeDaemonEndpoints(self):
        ...
        """
        model = openshift.client.models.v1_node_daemon_endpoints.V1NodeDaemonEndpoints()
