...
from openshift.client.models.v1_horizontal_pod_autoscaler_spec import V1HorizontalPodAutoscalerSpec
...
class TestV1HorizontalPodAutoscalerSpec(unittest.TestCase):
    ...
    def testV1HorizontalPodAutoscalerSpec(self):
        ...
        """
        model = openshift.client.models.v1_horizontal_pod_autoscaler_spec.V1HorizontalPodAutoscalerSpec()
