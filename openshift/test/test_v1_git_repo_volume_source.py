...
from openshift.client.models.v1_git_repo_volume_source import V1GitRepoVolumeSource
...
class TestV1GitRepoVolumeSource(unittest.TestCase):
    ...
    def testV1GitRepoVolumeSource(self):
        ...
        """
        model = openshift.client.models.v1_git_repo_volume_source.V1GitRepoVolumeSource()
