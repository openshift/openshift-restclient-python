...
from openshift.client.models.v1beta1_subject_access_review_status import V1beta1SubjectAccessReviewStatus
...
class TestV1beta1SubjectAccessReviewStatus(unittest.TestCase):
    ...
    def testV1beta1SubjectAccessReviewStatus(self):
        ...
        """
        model = openshift.client.models.v1beta1_subject_access_review_status.V1beta1SubjectAccessReviewStatus()
