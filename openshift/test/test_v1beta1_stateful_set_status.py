...
from openshift.client.models.v1beta1_stateful_set_status import V1beta1StatefulSetStatus
...
class TestV1beta1StatefulSetStatus(unittest.TestCase):
    ...
    def testV1beta1StatefulSetStatus(self):
        ...
        """
        model = openshift.client.models.v1beta1_stateful_set_status.V1beta1StatefulSetStatus()
