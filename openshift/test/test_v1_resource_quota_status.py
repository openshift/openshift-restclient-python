...
from openshift.client.models.v1_resource_quota_status import V1ResourceQuotaStatus
...
class TestV1ResourceQuotaStatus(unittest.TestCase):
    ...
    def testV1ResourceQuotaStatus(self):
        ...
        """
        model = openshift.client.models.v1_resource_quota_status.V1ResourceQuotaStatus()
