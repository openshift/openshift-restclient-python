...
from openshift.client.models.v1beta1_pod_disruption_budget_status import V1beta1PodDisruptionBudgetStatus
...
class TestV1beta1PodDisruptionBudgetStatus(unittest.TestCase):
    ...
    def testV1beta1PodDisruptionBudgetStatus(self):
        ...
        """
        model = openshift.client.models.v1beta1_pod_disruption_budget_status.V1beta1PodDisruptionBudgetStatus()
