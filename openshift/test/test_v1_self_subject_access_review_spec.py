...
from openshift.client.models.v1_self_subject_access_review_spec import V1SelfSubjectAccessReviewSpec
...
class TestV1SelfSubjectAccessReviewSpec(unittest.TestCase):
    ...
    def testV1SelfSubjectAccessReviewSpec(self):
        ...
        """
        model = openshift.client.models.v1_self_subject_access_review_spec.V1SelfSubjectAccessReviewSpec()
