...
from openshift.client.models.v1_resource_attributes import V1ResourceAttributes
...
class TestV1ResourceAttributes(unittest.TestCase):
    ...
    def testV1ResourceAttributes(self):
        ...
        """
        model = openshift.client.models.v1_resource_attributes.V1ResourceAttributes()
