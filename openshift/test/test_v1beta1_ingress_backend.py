...
from openshift.client.models.v1beta1_ingress_backend import V1beta1IngressBackend
...
class TestV1beta1IngressBackend(unittest.TestCase):
    ...
    def testV1beta1IngressBackend(self):
        ...
        """
        model = openshift.client.models.v1beta1_ingress_backend.V1beta1IngressBackend()
