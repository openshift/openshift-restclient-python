...
from openshift.openshift.client.apis.extensions_v1beta1_api import ExtensionsV1beta1Api
...
class TestExtensionsV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openshift.openshift.client.apis.extensions_v1beta1_api.ExtensionsV1beta1Api()
