...
from openshift.client.models.v1_controller_revision import V1ControllerRevision
...
class TestV1ControllerRevision(unittest.TestCase):
    ...
    def testV1ControllerRevision(self):
        ...
        #model = openshift.client.models.v1_controller_revision.V1ControllerRevision()
        pass
