...
from openshift.client.models.v1beta1_local_subject_access_review import V1beta1LocalSubjectAccessReview
...
class TestV1beta1LocalSubjectAccessReview(unittest.TestCase):
    ...
    def testV1beta1LocalSubjectAccessReview(self):
        ...
        """
        model = openshift.client.models.v1beta1_local_subject_access_review.V1beta1LocalSubjectAccessReview()
