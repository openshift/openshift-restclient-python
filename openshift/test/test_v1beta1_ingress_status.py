...
from openshift.client.models.v1beta1_ingress_status import V1beta1IngressStatus
...
class TestV1beta1IngressStatus(unittest.TestCase):
    ...
    def testV1beta1IngressStatus(self):
        ...
        """
        model = openshift.client.models.v1beta1_ingress_status.V1beta1IngressStatus()
