...
from openshift.client.models.v2alpha1_cron_job_spec import V2alpha1CronJobSpec
...
class TestV2alpha1CronJobSpec(unittest.TestCase):
    ...
    def testV2alpha1CronJobSpec(self):
        ...
        """
        model = openshift.client.models.v2alpha1_cron_job_spec.V2alpha1CronJobSpec()
