...
from openshift.client.models.v1_object_field_selector import V1ObjectFieldSelector
...
class TestV1ObjectFieldSelector(unittest.TestCase):
    ...
    def testV1ObjectFieldSelector(self):
        ...
        """
        model = openshift.client.models.v1_object_field_selector.V1ObjectFieldSelector()
