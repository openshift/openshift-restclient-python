...
from openshift.openshift.client.apis.image_openshift_io_v1_api import ImageOpenshiftIoV1Api
...
class TestImageOpenshiftIoV1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openshift.openshift.client.apis.image_openshift_io_v1_api.ImageOpenshiftIoV1Api()
