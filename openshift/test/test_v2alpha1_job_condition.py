...
from openshift.client.models.v2alpha1_job_condition import V2alpha1JobCondition
...
class TestV2alpha1JobCondition(unittest.TestCase):
    ...
    def testV2alpha1JobCondition(self):
        ...
        """
        model = openshift.client.models.v2alpha1_job_condition.V2alpha1JobCondition()
