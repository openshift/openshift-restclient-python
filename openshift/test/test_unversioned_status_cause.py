...
from openshift.client.models.unversioned_status_cause import UnversionedStatusCause
...
class TestUnversionedStatusCause(unittest.TestCase):
    ...
    def testUnversionedStatusCause(self):
        ...
        """
        model = openshift.client.models.unversioned_status_cause.UnversionedStatusCause()
