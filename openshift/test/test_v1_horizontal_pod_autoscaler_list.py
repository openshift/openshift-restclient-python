...
from openshift.client.models.v1_horizontal_pod_autoscaler_list import V1HorizontalPodAutoscalerList
...
class TestV1HorizontalPodAutoscalerList(unittest.TestCase):
    ...
    def testV1HorizontalPodAutoscalerList(self):
        ...
        """
        model = openshift.client.models.v1_horizontal_pod_autoscaler_list.V1HorizontalPodAutoscalerList()
