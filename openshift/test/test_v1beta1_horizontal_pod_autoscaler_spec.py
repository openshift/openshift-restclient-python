...
from openshift.client.models.v1beta1_horizontal_pod_autoscaler_spec import V1beta1HorizontalPodAutoscalerSpec
...
class TestV1beta1HorizontalPodAutoscalerSpec(unittest.TestCase):
    ...
    def testV1beta1HorizontalPodAutoscalerSpec(self):
        ...
        """
        model = openshift.client.models.v1beta1_horizontal_pod_autoscaler_spec.V1beta1HorizontalPodAutoscalerSpec()
