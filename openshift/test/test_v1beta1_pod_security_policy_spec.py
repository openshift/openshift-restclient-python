...
from openshift.client.models.v1beta1_pod_security_policy_spec import V1beta1PodSecurityPolicySpec
...
class TestV1beta1PodSecurityPolicySpec(unittest.TestCase):
    ...
    def testV1beta1PodSecurityPolicySpec(self):
        ...
        """
        model = openshift.client.models.v1beta1_pod_security_policy_spec.V1beta1PodSecurityPolicySpec()
