...
from openshift.client.apis.certificates_v1alpha1_api import CertificatesV1alpha1Api
...
class TestCertificatesV1alpha1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openshift.client.apis.certificates_v1alpha1_api.CertificatesV1alpha1Api()
