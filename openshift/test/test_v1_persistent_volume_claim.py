...
from openshift.client.models.v1_persistent_volume_claim import V1PersistentVolumeClaim
...
class TestV1PersistentVolumeClaim(unittest.TestCase):
    ...
    def testV1PersistentVolumeClaim(self):
        ...
        """
        model = openshift.client.models.v1_persistent_volume_claim.V1PersistentVolumeClaim()
