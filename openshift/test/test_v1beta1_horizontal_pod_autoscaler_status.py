...
from openshift.client.models.v1beta1_horizontal_pod_autoscaler_status import V1beta1HorizontalPodAutoscalerStatus
...
class TestV1beta1HorizontalPodAutoscalerStatus(unittest.TestCase):
    ...
    def testV1beta1HorizontalPodAutoscalerStatus(self):
        ...
        """
        model = openshift.client.models.v1beta1_horizontal_pod_autoscaler_status.V1beta1HorizontalPodAutoscalerStatus()
