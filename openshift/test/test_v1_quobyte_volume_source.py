...
from openshift.client.models.v1_quobyte_volume_source import V1QuobyteVolumeSource
...
class TestV1QuobyteVolumeSource(unittest.TestCase):
    ...
    def testV1QuobyteVolumeSource(self):
        ...
        """
        model = openshift.client.models.v1_quobyte_volume_source.V1QuobyteVolumeSource()
