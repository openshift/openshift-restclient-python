...
from openshift.client.models.v1_server_address_by_client_cidr import V1ServerAddressByClientCIDR
...
class TestV1ServerAddressByClientCIDR(unittest.TestCase):
    ...
    def testV1ServerAddressByClientCIDR(self):
        ...
        """
        model = openshift.client.models.v1_server_address_by_client_cidr.V1ServerAddressByClientCIDR()
