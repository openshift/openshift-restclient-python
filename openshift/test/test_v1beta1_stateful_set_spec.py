...
from openshift.client.models.v1beta1_stateful_set_spec import V1beta1StatefulSetSpec
...
class TestV1beta1StatefulSetSpec(unittest.TestCase):
    ...
    def testV1beta1StatefulSetSpec(self):
        ...
        """
        model = openshift.client.models.v1beta1_stateful_set_spec.V1beta1StatefulSetSpec()
