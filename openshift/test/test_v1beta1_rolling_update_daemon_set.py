...
from openshift.client.models.v1beta1_rolling_update_daemon_set import V1beta1RollingUpdateDaemonSet
...
class TestV1beta1RollingUpdateDaemonSet(unittest.TestCase):
    ...
    def testV1beta1RollingUpdateDaemonSet(self):
        ...
        """
        model = openshift.client.models.v1beta1_rolling_update_daemon_set.V1beta1RollingUpdateDaemonSet()
