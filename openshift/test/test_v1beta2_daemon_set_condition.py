...
from openshift.client.models.v1beta2_daemon_set_condition import V1beta2DaemonSetCondition
...
class TestV1beta2DaemonSetCondition(unittest.TestCase):
    ...
    def testV1beta2DaemonSetCondition(self):
        ...
        #model = openshift.client.models.v1beta2_daemon_set_condition.V1beta2DaemonSetCondition()
        pass
