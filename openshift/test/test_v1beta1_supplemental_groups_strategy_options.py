...
from openshift.client.models.v1beta1_supplemental_groups_strategy_options import V1beta1SupplementalGroupsStrategyOptions
...
class TestV1beta1SupplementalGroupsStrategyOptions(unittest.TestCase):
    ...
    def testV1beta1SupplementalGroupsStrategyOptions(self):
        ...
        """
        model = openshift.client.models.v1beta1_supplemental_groups_strategy_options.V1beta1SupplementalGroupsStrategyOptions()
