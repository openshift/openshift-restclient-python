...
from openshift.client.models.v1beta1_deployment_rollback import V1beta1DeploymentRollback
...
class TestV1beta1DeploymentRollback(unittest.TestCase):
    ...
    def testV1beta1DeploymentRollback(self):
        ...
        """
        model = openshift.client.models.v1beta1_deployment_rollback.V1beta1DeploymentRollback()
