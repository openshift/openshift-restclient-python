...
from openshift.client.models.v1_persistent_volume_spec import V1PersistentVolumeSpec
...
class TestV1PersistentVolumeSpec(unittest.TestCase):
    ...
    def testV1PersistentVolumeSpec(self):
        ...
        """
        model = openshift.client.models.v1_persistent_volume_spec.V1PersistentVolumeSpec()
