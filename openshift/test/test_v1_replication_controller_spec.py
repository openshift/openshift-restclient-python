...
from openshift.client.models.v1_replication_controller_spec import V1ReplicationControllerSpec
...
class TestV1ReplicationControllerSpec(unittest.TestCase):
    ...
    def testV1ReplicationControllerSpec(self):
        ...
        """
        model = openshift.client.models.v1_replication_controller_spec.V1ReplicationControllerSpec()
