...
from openshift.client.models.v1_non_resource_attributes import V1NonResourceAttributes
...
class TestV1NonResourceAttributes(unittest.TestCase):
    ...
    def testV1NonResourceAttributes(self):
        ...
        """
        model = openshift.client.models.v1_non_resource_attributes.V1NonResourceAttributes()
