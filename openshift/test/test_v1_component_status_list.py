...
from openshift.client.models.v1_component_status_list import V1ComponentStatusList
...
class TestV1ComponentStatusList(unittest.TestCase):
    ...
    def testV1ComponentStatusList(self):
        ...
        """
        model = openshift.client.models.v1_component_status_list.V1ComponentStatusList()
