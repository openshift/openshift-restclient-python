...
from openshift.client.models.v1alpha1_certificate_signing_request_spec import V1alpha1CertificateSigningRequestSpec
...
class TestV1alpha1CertificateSigningRequestSpec(unittest.TestCase):
    ...
    def testV1alpha1CertificateSigningRequestSpec(self):
        ...
        """
        model = openshift.client.models.v1alpha1_certificate_signing_request_spec.V1alpha1CertificateSigningRequestSpec()
