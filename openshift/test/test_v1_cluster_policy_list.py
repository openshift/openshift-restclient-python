...
from openshift.client.models.v1_cluster_policy_list import V1ClusterPolicyList
...
class TestV1ClusterPolicyList(unittest.TestCase):
    ...
    def testV1ClusterPolicyList(self):
        ...
        """
        model = openshift.client.models.v1_cluster_policy_list.V1ClusterPolicyList()
