...
from openshift.client.models.v1_flocker_volume_source import V1FlockerVolumeSource
...
class TestV1FlockerVolumeSource(unittest.TestCase):
    ...
    def testV1FlockerVolumeSource(self):
        ...
        """
        model = openshift.client.models.v1_flocker_volume_source.V1FlockerVolumeSource()
