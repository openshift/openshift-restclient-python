...
from openshift.client.models.v1beta1_rolling_update_deployment import V1beta1RollingUpdateDeployment
...
class TestV1beta1RollingUpdateDeployment(unittest.TestCase):
    ...
    def testV1beta1RollingUpdateDeployment(self):
        ...
        """
        model = openshift.client.models.v1beta1_rolling_update_deployment.V1beta1RollingUpdateDeployment()
