...
from openshift.client.models.v1alpha1_certificate_signing_request_condition import V1alpha1CertificateSigningRequestCondition
...
class TestV1alpha1CertificateSigningRequestCondition(unittest.TestCase):
    ...
    def testV1alpha1CertificateSigningRequestCondition(self):
        ...
        """
        model = openshift.client.models.v1alpha1_certificate_signing_request_condition.V1alpha1CertificateSigningRequestCondition()
