...
from openshift.client.models.v1_deprecated_downward_api_volume_source import V1DeprecatedDownwardAPIVolumeSource


class TestV1DeprecatedDownwardAPIVolumeSource(unittest.TestCase):
    """ V1DeprecatedDownwardAPIVolumeSource unit test stubs """
    ...
    def testV1DeprecatedDownwardAPIVolumeSource(self):
        """
        Test V1DeprecatedDownwardAPIVolumeSource
        """
        model = openshift.client.models.v1_deprecated_downward_api_volume_source.V1DeprecatedDownwardAPIVolumeSource()
