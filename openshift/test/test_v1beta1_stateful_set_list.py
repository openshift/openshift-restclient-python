...
from openshift.client.models.v1beta1_stateful_set_list import V1beta1StatefulSetList
...
class TestV1beta1StatefulSetList(unittest.TestCase):
    ...
    def testV1beta1StatefulSetList(self):
        ...
        """
        model = openshift.client.models.v1beta1_stateful_set_list.V1beta1StatefulSetList()
