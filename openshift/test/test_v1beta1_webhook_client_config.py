...
from openshift.client.models.v1beta1_webhook_client_config import V1beta1WebhookClientConfig
...
class TestV1beta1WebhookClientConfig(unittest.TestCase):
    ...
    def testV1beta1WebhookClientConfig(self):
        ...
        #model = openshift.client.models.v1beta1_webhook_client_config.V1beta1WebhookClientConfig()
        pass
