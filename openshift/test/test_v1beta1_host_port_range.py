...
from openshift.client.models.v1beta1_host_port_range import V1beta1HostPortRange
...
class TestV1beta1HostPortRange(unittest.TestCase):
    ...
    def testV1beta1HostPortRange(self):
        ...
        """
        model = openshift.client.models.v1beta1_host_port_range.V1beta1HostPortRange()
