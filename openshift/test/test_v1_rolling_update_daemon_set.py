...
from openshift.client.models.v1_rolling_update_daemon_set import V1RollingUpdateDaemonSet
...
class TestV1RollingUpdateDaemonSet(unittest.TestCase):
    ...
    def testV1RollingUpdateDaemonSet(self):
        ...
        #model = openshift.client.models.v1_rolling_update_daemon_set.V1RollingUpdateDaemonSet()
        pass
