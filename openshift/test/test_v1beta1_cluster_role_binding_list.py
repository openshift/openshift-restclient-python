...
from openshift.client.models.v1beta1_cluster_role_binding_list import V1beta1ClusterRoleBindingList
...
class TestV1beta1ClusterRoleBindingList(unittest.TestCase):
    ...
    def testV1beta1ClusterRoleBindingList(self):
        ...
        """
        model = openshift.client.models.v1beta1_cluster_role_binding_list.V1beta1ClusterRoleBindingList()
