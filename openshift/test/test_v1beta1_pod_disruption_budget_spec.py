...
from openshift.client.models.v1beta1_pod_disruption_budget_spec import V1beta1PodDisruptionBudgetSpec
...
class TestV1beta1PodDisruptionBudgetSpec(unittest.TestCase):
    ...
    def testV1beta1PodDisruptionBudgetSpec(self):
        ...
        """
        model = openshift.client.models.v1beta1_pod_disruption_budget_spec.V1beta1PodDisruptionBudgetSpec()
