...
from openshift.client.models.v1_downward_api_projection import V1DownwardAPIProjection
...
class TestV1DownwardAPIProjection(unittest.TestCase):
    ...
    def testV1DownwardAPIProjection(self):
        ...
        """
        model = openshift.client.models.v1_downward_api_projection.V1DownwardAPIProjection()
