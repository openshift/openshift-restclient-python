...
from openshift.client.models.v1_label_selector_requirement import V1LabelSelectorRequirement
...
class TestV1LabelSelectorRequirement(unittest.TestCase):
    ...
    def testV1LabelSelectorRequirement(self):
        ...
        """
        model = openshift.client.models.v1_label_selector_requirement.V1LabelSelectorRequirement()
