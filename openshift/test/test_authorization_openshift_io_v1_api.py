...
from openshift.openshift.client.apis.authorization_openshift_io_v1_api import AuthorizationOpenshiftIoV1Api
...
class TestAuthorizationOpenshiftIoV1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openshift.openshift.client.apis.authorization_openshift_io_v1_api.AuthorizationOpenshiftIoV1Api()
