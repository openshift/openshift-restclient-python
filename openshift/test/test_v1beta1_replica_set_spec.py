...
from openshift.client.models.v1beta1_replica_set_spec import V1beta1ReplicaSetSpec
...
class TestV1beta1ReplicaSetSpec(unittest.TestCase):
    ...
    def testV1beta1ReplicaSetSpec(self):
        ...
        """
        model = openshift.client.models.v1beta1_replica_set_spec.V1beta1ReplicaSetSpec()
