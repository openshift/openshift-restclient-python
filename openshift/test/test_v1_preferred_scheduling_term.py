...
from openshift.client.models.v1_preferred_scheduling_term import V1PreferredSchedulingTerm
...
class TestV1PreferredSchedulingTerm(unittest.TestCase):
    ...
    def testV1PreferredSchedulingTerm(self):
        ...
        """
        model = openshift.client.models.v1_preferred_scheduling_term.V1PreferredSchedulingTerm()
