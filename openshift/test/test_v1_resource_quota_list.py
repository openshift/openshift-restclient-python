...
from openshift.client.models.v1_resource_quota_list import V1ResourceQuotaList
...
class TestV1ResourceQuotaList(unittest.TestCase):
    ...
    def testV1ResourceQuotaList(self):
        ...
        """
        model = openshift.client.models.v1_resource_quota_list.V1ResourceQuotaList()
