...
from openshift.client.models.v1beta1_certificate_signing_request_spec import V1beta1CertificateSigningRequestSpec
...
class TestV1beta1CertificateSigningRequestSpec(unittest.TestCase):
    ...
    def testV1beta1CertificateSigningRequestSpec(self):
        ...
        """
        model = openshift.client.models.v1beta1_certificate_signing_request_spec.V1beta1CertificateSigningRequestSpec()
