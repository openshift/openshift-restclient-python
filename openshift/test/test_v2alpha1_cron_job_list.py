...
from openshift.client.models.v2alpha1_cron_job_list import V2alpha1CronJobList
...
class TestV2alpha1CronJobList(unittest.TestCase):
    ...
    def testV2alpha1CronJobList(self):
        ...
        """
        model = openshift.client.models.v2alpha1_cron_job_list.V2alpha1CronJobList()
