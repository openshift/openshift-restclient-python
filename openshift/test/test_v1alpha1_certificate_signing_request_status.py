...
from openshift.client.models.v1alpha1_certificate_signing_request_status import V1alpha1CertificateSigningRequestStatus
...
class TestV1alpha1CertificateSigningRequestStatus(unittest.TestCase):
    ...
    def testV1alpha1CertificateSigningRequestStatus(self):
        ...
        """
        model = openshift.client.models.v1alpha1_certificate_signing_request_status.V1alpha1CertificateSigningRequestStatus()
