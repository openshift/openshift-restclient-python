...
from openshift.client.models.v1_persistent_volume_list import V1PersistentVolumeList
...
class TestV1PersistentVolumeList(unittest.TestCase):
    ...
    def testV1PersistentVolumeList(self):
        ...
        """
        model = openshift.client.models.v1_persistent_volume_list.V1PersistentVolumeList()
