...
from openshift.client.models.v1_controller_revision_list import V1ControllerRevisionList
...
class TestV1ControllerRevisionList(unittest.TestCase):
    ...
    def testV1ControllerRevisionList(self):
        ...
        #model = openshift.client.models.v1_controller_revision_list.V1ControllerRevisionList()
        pass
