...
from openshift.client.models.v1beta1_cluster_role_binding import V1beta1ClusterRoleBinding
...
class TestV1beta1ClusterRoleBinding(unittest.TestCase):
    ...
    def testV1beta1ClusterRoleBinding(self):
        ...
        """
        model = openshift.client.models.v1beta1_cluster_role_binding.V1beta1ClusterRoleBinding()
