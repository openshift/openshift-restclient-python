...
from openshift.client.models.v1beta1_self_subject_access_review_spec import V1beta1SelfSubjectAccessReviewSpec
...
class TestV1beta1SelfSubjectAccessReviewSpec(unittest.TestCase):
    ...
    def testV1beta1SelfSubjectAccessReviewSpec(self):
        ...
        """
        model = openshift.client.models.v1beta1_self_subject_access_review_spec.V1beta1SelfSubjectAccessReviewSpec()
