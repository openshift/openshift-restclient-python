...
from openshift.client.models.v1beta1_replica_set_list import V1beta1ReplicaSetList
...
class TestV1beta1ReplicaSetList(unittest.TestCase):
    ...
    def testV1beta1ReplicaSetList(self):
        ...
        """
        model = openshift.client.models.v1beta1_replica_set_list.V1beta1ReplicaSetList()
