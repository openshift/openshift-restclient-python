...
from openshift.client.models.v1beta1_run_as_user_strategy_options import V1beta1RunAsUserStrategyOptions
...
class TestV1beta1RunAsUserStrategyOptions(unittest.TestCase):
    ...
    def testV1beta1RunAsUserStrategyOptions(self):
        ...
        """
        model = openshift.client.models.v1beta1_run_as_user_strategy_options.V1beta1RunAsUserStrategyOptions()
