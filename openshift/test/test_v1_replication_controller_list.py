...
from openshift.client.models.v1_replication_controller_list import V1ReplicationControllerList
...
class TestV1ReplicationControllerList(unittest.TestCase):
    ...
    def testV1ReplicationControllerList(self):
        ...
        """
        model = openshift.client.models.v1_replication_controller_list.V1ReplicationControllerList()
