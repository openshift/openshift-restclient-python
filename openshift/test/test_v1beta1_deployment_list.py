...
from openshift.client.models.v1beta1_deployment_list import V1beta1DeploymentList
...
class TestV1beta1DeploymentList(unittest.TestCase):
    ...
    def testV1beta1DeploymentList(self):
        ...
        """
        model = openshift.client.models.v1beta1_deployment_list.V1beta1DeploymentList()
