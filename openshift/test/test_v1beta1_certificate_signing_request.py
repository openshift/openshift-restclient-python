...
from openshift.client.models.v1beta1_certificate_signing_request import V1beta1CertificateSigningRequest
...
class TestV1beta1CertificateSigningRequest(unittest.TestCase):
    ...
    def testV1beta1CertificateSigningRequest(self):
        ...
        """
        model = openshift.client.models.v1beta1_certificate_signing_request.V1beta1CertificateSigningRequest()
