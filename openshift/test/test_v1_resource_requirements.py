...
from openshift.client.models.v1_resource_requirements import V1ResourceRequirements
...
class TestV1ResourceRequirements(unittest.TestCase):
    ...
    def testV1ResourceRequirements(self):
        ...
        """
        model = openshift.client.models.v1_resource_requirements.V1ResourceRequirements()
