...
from openshift.client.models.v1_subject_access_review_status import V1SubjectAccessReviewStatus
...
class TestV1SubjectAccessReviewStatus(unittest.TestCase):
    ...
    def testV1SubjectAccessReviewStatus(self):
        ...
        """
        model = openshift.client.models.v1_subject_access_review_status.V1SubjectAccessReviewStatus()
