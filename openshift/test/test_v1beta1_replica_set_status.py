...
from openshift.client.models.v1beta1_replica_set_status import V1beta1ReplicaSetStatus
...
class TestV1beta1ReplicaSetStatus(unittest.TestCase):
    ...
    def testV1beta1ReplicaSetStatus(self):
        ...
        """
        model = openshift.client.models.v1beta1_replica_set_status.V1beta1ReplicaSetStatus()
