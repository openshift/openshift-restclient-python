...
from openshift.client.models.v1beta1_token_review_spec import V1beta1TokenReviewSpec
...
class TestV1beta1TokenReviewSpec(unittest.TestCase):
    ...
    def testV1beta1TokenReviewSpec(self):
        ...
        """
        model = openshift.client.models.v1beta1_token_review_spec.V1beta1TokenReviewSpec()
