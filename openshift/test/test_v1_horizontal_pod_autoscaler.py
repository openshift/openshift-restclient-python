...
from openshift.client.models.v1_horizontal_pod_autoscaler import V1HorizontalPodAutoscaler
...
class TestV1HorizontalPodAutoscaler(unittest.TestCase):
    ...
    def testV1HorizontalPodAutoscaler(self):
        ...
        """
        model = openshift.client.models.v1_horizontal_pod_autoscaler.V1HorizontalPodAutoscaler()
