...
from openshift.client.models.v1beta1_cluster_role_list import V1beta1ClusterRoleList
...
class TestV1beta1ClusterRoleList(unittest.TestCase):
    ...
    def testV1beta1ClusterRoleList(self):
        ...
        """
        model = openshift.client.models.v1beta1_cluster_role_list.V1beta1ClusterRoleList()
