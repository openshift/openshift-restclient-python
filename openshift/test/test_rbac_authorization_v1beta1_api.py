...
from openshift.openshift.client.apis.rbac_authorization_v1beta1_api import RbacAuthorizationV1beta1Api
...
class TestRbacAuthorizationV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openshift.openshift.client.apis.rbac_authorization_v1beta1_api.RbacAuthorizationV1beta1Api()
