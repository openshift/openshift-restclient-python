...
from openshift.client.models.v1_policy_binding_list import V1PolicyBindingList
...
class TestV1PolicyBindingList(unittest.TestCase):
    ...
    def testV1PolicyBindingList(self):
        ...
        """
        model = openshift.client.models.v1_policy_binding_list.V1PolicyBindingList()
