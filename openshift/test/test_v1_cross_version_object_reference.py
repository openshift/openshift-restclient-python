...
from openshift.client.models.v1_cross_version_object_reference import V1CrossVersionObjectReference
...
class TestV1CrossVersionObjectReference(unittest.TestCase):
    ...
    def testV1CrossVersionObjectReference(self):
        ...
        """
        model = openshift.client.models.v1_cross_version_object_reference.V1CrossVersionObjectReference()
