...
class TemplateOpenshiftIoApi(object):
    ...
    def create_namespaced_processed_template_v1(self, body, namespace, **kwargs):
        """
        create a Template
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_namespaced_processed_template_v1(body, namespace, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.create_namespaced_processed_template_v1_with_http_info(body, namespace, **kwargs)
        else:
            (data) = self.create_namespaced_processed_template_v1_with_http_info(body, namespace, **kwargs)
            return data

    def create_namespaced_processed_template_v1_with_http_info(self, body, namespace, **kwargs):
        """
        create a Template
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_namespaced_processed_template_v1_with_http_info(body, namespace, callback=callback_function)
