...
class EventsV1beta1Api(object):
    ...
    def create_event_for_all_namespaces(self, body, **kwargs):
        """
        create an Event
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_event_for_all_namespaces(body, async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.create_event_for_all_namespaces_with_http_info(body, **kwargs)
        else:
            (data) = self.create_event_for_all_namespaces_with_http_info(body, **kwargs)
            return data

    def create_event_for_all_namespaces_with_http_info(self, body, **kwargs):
        """
        create an Event
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_event_for_all_namespaces_with_http_info(body, async=True)
        >>> result = thread.get()
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_event_for_all_namespaces" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_event_for_all_namespaces`")
        ...
        return self.api_client.call_api('/apis/events.k8s.io/v1beta1/events', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
