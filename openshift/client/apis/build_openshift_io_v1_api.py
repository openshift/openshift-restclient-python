...
class BuildOpenshiftIoV1Api(object):
    ...
    def connect_post_namespaced_build_config_instantiatebinary_with_http_info(self, name, namespace, **kwargs):
        ...
        resource_path = '/apis/build.openshift.io/v1/namespaces/{namespace}/buildconfigs/{name}/instantiatebinary'.replace('{format}', 'json')
        path_params = {}
        if 'name' in params:
    ...
    def connect_post_namespaced_build_config_webhooks_with_http_info(self, name, namespace, **kwargs):
        ...
        resource_path = '/apis/build.openshift.io/v1/namespaces/{namespace}/buildconfigs/{name}/webhooks'.replace('{format}', 'json')
        path_params = {}
        if 'name' in params:
            path_params['name'] = params['name']
        if 'namespace' in params:
    ...
    def connect_post_namespaced_build_config_webhooks_with_path_with_http_info(self, name, namespace, path, **kwargs):
        ...
        resource_path = '/apis/build.openshift.io/v1/namespaces/{namespace}/buildconfigs/{name}/webhooks/{path}'.replace('{format}', 'json')
        path_params = {}
        if 'name' in params:
            path_params['name'] = params['name']
        if 'namespace' in params:
    ...
    def create_build_config_for_all_namespaces_with_http_info(self, body, **kwargs):
        ...
        resource_path = '/apis/build.openshift.io/v1/buildconfigs'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_build_for_all_namespaces_with_http_info(self, body, **kwargs):
        ...
        resource_path = '/apis/build.openshift.io/v1/builds'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_namespaced_build_with_http_info(self, namespace, body, **kwargs):
        ...
        resource_path = '/apis/build.openshift.io/v1/namespaces/{namespace}/builds'.replace('{format}', 'json')
        path_params = {}
        if 'namespace' in params:
            path_params['namespace'] = params['namespace']
    ...
    def create_namespaced_build_config_with_http_info(self, namespace, body, **kwargs):
        ...
        resource_path = '/apis/build.openshift.io/v1/namespaces/{namespace}/buildconfigs'.replace('{format}', 'json')
        path_params = {}
        if 'namespace' in params:
            path_params['namespace'] = params['namespace']
    ...
    def create_namespaced_build_config_instantiate_with_http_info(self, name, namespace, body, **kwargs):
        ...
        resource_path = '/apis/build.openshift.io/v1/namespaces/{namespace}/buildconfigs/{name}/instantiate'.replace('{format}', 'json')
        path_params = {}
        if 'name' in params:
            path_params['name'] = params['name']
        if 'namespace' in params:
    ...
    def delete_namespaced_build_with_http_info(self, name, namespace, body, **kwargs):
        ...
        resource_path = '/apis/build.openshift.io/v1/namespaces/{namespace}/builds/{name}'.replace('{format}', 'json')
        path_params = {}
        if 'name' in params:
            path_params['name'] = params['name']
        if 'namespace' in params:
    ...
    def delete_namespaced_build_config_with_http_info(self, name, namespace, body, **kwargs):
        ...
        resource_path = '/apis/build.openshift.io/v1/namespaces/{namespace}/buildconfigs/{name}'.replace('{format}', 'json')
        path_params = {}
        if 'name' in params:
            path_params['name'] = params['name']
        if 'namespace' in params:
    ...
    def get_api_resources_with_http_info(self, **kwargs):
        ...
        resource_path = '/apis/build.openshift.io/v1/'.replace('{format}', 'json')
        path_params = {}
    ...
    def read_namespaced_build_log_with_http_info(self, name, namespace, **kwargs):
        ...
        resource_path = '/apis/build.openshift.io/v1/namespaces/{namespace}/builds/{name}/log'.replace('{format}', 'json')
        path_params = {}
        if 'name' in params:
            path_params['name'] = params['name']
        if 'namespace' in params:
    ...
    def replace_namespaced_build_details_with_http_info(self, name, namespace, body, **kwargs):
        ...
        resource_path = '/apis/build.openshift.io/v1/namespaces/{namespace}/builds/{name}/details'.replace('{format}', 'json')
        path_params = {}
        if 'name' in params:
            path_params['name'] = params['name']
        if 'namespace' in params:
