...
class BatchV2alpha1Api(object):
    ...
    def create_cron_job_for_all_namespaces(self, body, **kwargs):
        """
        create a CronJob
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_cron_job_for_all_namespaces(body, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.create_cron_job_for_all_namespaces_with_http_info(body, **kwargs)
        else:
            (data) = self.create_cron_job_for_all_namespaces_with_http_info(body, **kwargs)
            return data

    def create_cron_job_for_all_namespaces_with_http_info(self, body, **kwargs):
        """
        create a CronJob
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_cron_job_for_all_namespaces_with_http_info(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_cron_job_for_all_namespaces" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_cron_job_for_all_namespaces`")
    ...
    def create_scheduled_job_for_all_namespaces(self, body, **kwargs):
        """
        create a ScheduledJob
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_scheduled_job_for_all_namespaces(body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_scheduled_job_for_all_namespaces_with_http_info(body, **kwargs)
        else:
            (data) = self.create_scheduled_job_for_all_namespaces_with_http_info(body, **kwargs)
            return data

    def create_scheduled_job_for_all_namespaces_with_http_info(self, body, **kwargs):
        """
        create a ScheduledJob
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_scheduled_job_for_all_namespaces_with_http_info(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_scheduled_job_for_all_namespaces" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_scheduled_job_for_all_namespaces`")
