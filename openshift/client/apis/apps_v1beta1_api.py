...
class AppsV1beta1Api(object):
    ...
    def create_stateful_set_for_all_namespaces(self, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_stateful_set_for_all_namespaces(body, callback=callback_function)
    ...
    def create_stateful_set_for_all_namespaces_with_http_info(self, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_stateful_set_for_all_namespaces_with_http_info(body, callback=callback_function)
