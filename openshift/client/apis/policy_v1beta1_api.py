...
class PolicyV1beta1Api(object):
    ...
    def create_pod_disruption_budget_for_all_namespaces(self, body, **kwargs):
        """
        create a PodDisruptionBudget
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_pod_disruption_budget_for_all_namespaces(body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_pod_disruption_budget_for_all_namespaces_with_http_info(body, **kwargs)
        else:
            (data) = self.create_pod_disruption_budget_for_all_namespaces_with_http_info(body, **kwargs)
            return data

    def create_pod_disruption_budget_for_all_namespaces_with_http_info(self, body, **kwargs):
        """
        create a PodDisruptionBudget
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_pod_disruption_budget_for_all_namespaces_with_http_info(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_pod_disruption_budget_for_all_namespaces" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_pod_disruption_budget_for_all_namespaces`")
