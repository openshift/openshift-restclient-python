...
class V1SubjectRulesReviewStatus(object):
    ...
    """
    def __init__(self, evaluation_error=None, rules=None):
        """
    ...
    def rules(self):
        """
        Gets the rules of this V1SubjectRulesReviewStatus.
        Rules is the list of rules (no particular sort) that are allowed for the subject

        :return: The rules of this V1SubjectRulesReviewStatus.
    ...
    def rules(self, rules):
        """
        Sets the rules of this V1SubjectRulesReviewStatus.
        Rules is the list of rules (no particular sort) that are allowed for the subject

        :param rules: The rules of this V1SubjectRulesReviewStatus.
