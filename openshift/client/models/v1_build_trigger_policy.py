...
class V1BuildTriggerPolicy(object):
    ...
    """
    def __init__(self, bitbucket=None, generic=None, github=None, gitlab=None, image_change=None, type=None):
        """
        ...
        """
        self.swagger_types = {
            'bitbucket': 'V1WebHookTrigger',
            'generic': 'V1WebHookTrigger',
            'github': 'V1WebHookTrigger',
            'gitlab': 'V1WebHookTrigger',
    ...
    def bitbucket(self):
        """
        Gets the bitbucket of this V1BuildTriggerPolicy.
        BitbucketWebHook contains the parameters for a Bitbucket webhook type of trigger

        :return: The bitbucket of this V1BuildTriggerPolicy.
    ...
    def bitbucket(self, bitbucket):
        """
        Sets the bitbucket of this V1BuildTriggerPolicy.
        BitbucketWebHook contains the parameters for a Bitbucket webhook type of trigger

        :param bitbucket: The bitbucket of this V1BuildTriggerPolicy.
    ...
    def gitlab(self):
        """
        Gets the gitlab of this V1BuildTriggerPolicy.
        GitLabWebHook contains the parameters for a GitLab webhook type of trigger

        :return: The gitlab of this V1BuildTriggerPolicy.
        :rtype: V1WebHookTrigger
        """
        return self._gitlab
    ...
    def gitlab(self, gitlab):
        """
        Sets the gitlab of this V1BuildTriggerPolicy.
        GitLabWebHook contains the parameters for a GitLab webhook type of trigger

        :param gitlab: The gitlab of this V1BuildTriggerPolicy.
        :type: V1WebHookTrigger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1BuildTriggerPolicy):
            return False
