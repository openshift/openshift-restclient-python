...
class V1BuildOutput(object):
    ...
    """
    def __init__(self, image_labels=None, push_secret=None, to=None):
        """
        ...
        """
        self.swagger_types = {
            'image_labels': 'list[V1ImageLabel]',
    ...
    def image_labels(self):
        """
        Gets the image_labels of this V1BuildOutput.
        ...
        :return: The image_labels of this V1BuildOutput.
        :rtype: list[V1ImageLabel]
        """
    ...
    def image_labels(self, image_labels):
        """
        Sets the image_labels of this V1BuildOutput.
        imageLabels define a list of labels that are applied to the resulting image. If there are multiple labels with the same name then the last one in the list is used.

        :param image_labels: The image_labels of this V1BuildOutput.
        :type: list[V1ImageLabel]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1BuildOutput):
            return False
