...
class V1ResourceAccessReview(object):
    ...
    """
    def __init__(self, api_version=None, content=None, kind=None, namespace=None, resource=None, resource_api_group=None, resource_api_version=None, resource_name=None, verb=None):
        """
