...
class V1Identity(object):
    ...
    """
    def __init__(self, api_version=None, extra=None, kind=None, metadata=None, provider_name=None, provider_user_name=None, user=None):
        """
    ...
    def provider_user_name(self, provider_user_name):
        ...
        :type: str
        """
        if provider_user_name is None:
            raise ValueError("Invalid value for `provider_user_name`, must not be `None`")
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1Identity):
            return False
