...
class V1ImageStreamImportSpec(object):
    ...
    """
    def __init__(self, images=None, _import=None, repository=None):
        """
    ...
    def _import(self, _import):
        ...
        """
        if _import is None:
            raise ValueError("Invalid value for `_import`, must not be `None`")
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1ImageStreamImportSpec):
            return False
