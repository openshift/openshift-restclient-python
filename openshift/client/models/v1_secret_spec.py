...
class V1SecretSpec(object):
    ...
    """
    def __init__(self, mount_path=None, secret_source=None):
        """
    ...
    def secret_source(self, secret_source):
        ...
        if secret_source is None:
            raise ValueError("Invalid value for `secret_source`, must not be `None`")
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1SecretSpec):
            return False
