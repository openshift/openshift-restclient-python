# openshift.openshift.client.PolicyV1beta1Api
...
[**create_pod_disruption_budget_for_all_namespaces**](PolicyV1beta1Api.md#create_pod_disruption_budget_for_all_namespaces) | **POST** /apis/policy/v1beta1/poddisruptionbudgets | 
...
api_instance = openshift.openshift.client.PolicyV1beta1Api()
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = openshift.openshift.client.V1beta1PodDisruptionBudget() # V1beta1PodDisruptionBudget | 
...
# **create_pod_disruption_budget_for_all_namespaces**
> V1beta1PodDisruptionBudget create_pod_disruption_budget_for_all_namespaces(body, pretty=pretty)
...
try: 
    api_response = api_instance.create_pod_disruption_budget_for_all_namespaces(body, pretty=pretty)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PolicyV1beta1Api->create_pod_disruption_budget_for_all_namespaces: %s\n" % e)
```
...
> V1beta1PodDisruptionBudgetList list_pod_disruption_budget_for_all_namespaces(pretty=pretty, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try: 
    api_response = api_instance.list_pod_disruption_budget_for_all_namespaces(pretty=pretty, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
