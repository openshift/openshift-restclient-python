# openshift.openshift.client.TemplateOpenshiftIoV1Api
...
api_instance = openshift.openshift.client.TemplateOpenshiftIoV1Api()
body = openshift.openshift.client.V1BrokerTemplateInstance() # V1BrokerTemplateInstance | 
...
api_instance = openshift.openshift.client.TemplateOpenshiftIoV1Api()
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = openshift.openshift.client.V1TemplateInstance() # V1TemplateInstance | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
