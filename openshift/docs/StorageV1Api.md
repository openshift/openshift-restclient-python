# openshift.openshift.client.StorageV1Api
...
api_instance = openshift.openshift.client.StorageV1Api()
body = openshift.openshift.client.V1StorageClass() # V1StorageClass | 
