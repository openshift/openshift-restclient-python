# openshift.openshift.client.NetworkingV1Api
...
[**create_network_policy_for_all_namespaces**](NetworkingV1Api.md#create_network_policy_for_all_namespaces) | **POST** /apis/networking.k8s.io/v1/networkpolicies | 
...
api_instance = openshift.openshift.client.NetworkingV1Api()
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = openshift.openshift.client.V1NetworkPolicy() # V1NetworkPolicy | 
...
> V1NetworkPolicy create_network_policy_for_all_namespaces(body, pretty=pretty)
...
try: 
    ...
    print("Exception when calling NetworkingV1Api->create_network_policy_for_all_namespaces: %s\n" % e)
```
...
> V1NetworkPolicyList list_network_policy_for_all_namespaces(pretty=pretty, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
