# openshift.openshift.client.AuthenticationV1Api
...
api_instance = openshift.openshift.client.AuthenticationV1Api()
body = openshift.openshift.client.V1TokenReview() # V1TokenReview | 
