# openshift.openshift.client.RbacAuthorizationV1beta1Api
...
[**create_role_binding_for_all_namespaces**](RbacAuthorizationV1beta1Api.md#create_role_binding_for_all_namespaces) | **POST** /apis/rbac.authorization.k8s.io/v1beta1/rolebindings | 
[**create_role_for_all_namespaces**](RbacAuthorizationV1beta1Api.md#create_role_for_all_namespaces) | **POST** /apis/rbac.authorization.k8s.io/v1beta1/roles | 
...
api_instance = openshift.openshift.client.RbacAuthorizationV1beta1Api()
body = openshift.openshift.client.V1beta1ClusterRole() # V1beta1ClusterRole | 
...
# create an instance of the API class
api_instance = openshift.openshift.client.RbacAuthorizationV1beta1Api()
body = openshift.openshift.client.V1beta1ClusterRoleBinding() # V1beta1ClusterRoleBinding | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
body = openshift.openshift.client.V1beta1Role() # V1beta1Role | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
api_instance = openshift.openshift.client.RbacAuthorizationV1beta1Api()
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = openshift.openshift.client.V1beta1RoleBinding() # V1beta1RoleBinding | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
> V1beta1RoleBinding create_role_binding_for_all_namespaces(body, pretty=pretty)
...
try: 
    ...
    print("Exception when calling RbacAuthorizationV1beta1Api->create_role_binding_for_all_namespaces: %s\n" % e)
```
...
> V1beta1Role create_role_for_all_namespaces(body, pretty=pretty)
...
try: 
    ...
    print("Exception when calling RbacAuthorizationV1beta1Api->create_role_for_all_namespaces: %s\n" % e)
```
...
> V1beta1RoleBindingList list_role_binding_for_all_namespaces(pretty=pretty, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1beta1RoleList list_role_for_all_namespaces(pretty=pretty, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
