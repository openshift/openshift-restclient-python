...
**openshift.openshift.client_name** | **str** | ClientName references the openshift.openshift.client that created this authorization | [optional] 
...
**user_name** | **str** | UserName is the user name that authorized this openshift.openshift.client | [optional] 
