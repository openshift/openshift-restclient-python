# openshift.client.EventsV1beta1Api

All URIs are relative to *https://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_event_for_all_namespaces**](EventsV1beta1Api.md#create_event_for_all_namespaces) | **POST** /apis/events.k8s.io/v1beta1/events | 
...
> V1beta1Event create_event_for_all_namespaces(body, pretty=pretty)
...
body = openshift.client.V1beta1Event() # V1beta1Event | 
...
try: 
    ...
    print("Exception when calling EventsV1beta1Api->create_event_for_all_namespaces: %s\n" % e)
```
...
> V1beta1EventList list_event_for_all_namespaces(pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try: 
    api_response = api_instance.list_event_for_all_namespaces(pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
