# openshift.client.AppsV1Api

All URIs are relative to *https://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_controller_revision_for_all_namespaces**](AppsV1Api.md#create_controller_revision_for_all_namespaces) | **POST** /apis/apps/v1/controllerrevisions | 
[**create_daemon_set_for_all_namespaces**](AppsV1Api.md#create_daemon_set_for_all_namespaces) | **POST** /apis/apps/v1/daemonsets | 
[**create_deployment_for_all_namespaces**](AppsV1Api.md#create_deployment_for_all_namespaces) | **POST** /apis/apps/v1/deployments | 
...
[**create_replica_set_for_all_namespaces**](AppsV1Api.md#create_replica_set_for_all_namespaces) | **POST** /apis/apps/v1/replicasets | 
[**create_stateful_set_for_all_namespaces**](AppsV1Api.md#create_stateful_set_for_all_namespaces) | **POST** /apis/apps/v1/statefulsets | 
...
# **create_controller_revision_for_all_namespaces**
> V1ControllerRevision create_controller_revision_for_all_namespaces(body, pretty=pretty)
...
api_instance = openshift.client.AppsV1Api(openshift.client.ApiClient(configuration))
body = openshift.client.V1ControllerRevision() # V1ControllerRevision | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)

try: 
    api_response = api_instance.create_controller_revision_for_all_namespaces(body, pretty=pretty)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling AppsV1Api->create_controller_revision_for_all_namespaces: %s\n" % e)
```
...
> V1DaemonSet create_daemon_set_for_all_namespaces(body, pretty=pretty)
...
# create an instance of the API class
api_instance = openshift.client.AppsV1Api(openshift.client.ApiClient(configuration))
body = openshift.client.V1DaemonSet() # V1DaemonSet | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
try: 
    ...
    print("Exception when calling AppsV1Api->create_daemon_set_for_all_namespaces: %s\n" % e)
```
...
> V1Deployment create_deployment_for_all_namespaces(body, pretty=pretty)
...
# create an instance of the API class
api_instance = openshift.client.AppsV1Api(openshift.client.ApiClient(configuration))
body = openshift.client.V1Deployment() # V1Deployment | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
try: 
    ...
    print("Exception when calling AppsV1Api->create_deployment_for_all_namespaces: %s\n" % e)
```
...
api_instance = openshift.client.AppsV1Api(openshift.client.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = openshift.client.V1ReplicaSet() # V1ReplicaSet | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
api_instance = openshift.client.AppsV1Api(openshift.client.ApiClient(configuration))
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = openshift.client.V1StatefulSet() # V1StatefulSet | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
...
> V1ReplicaSet create_replica_set_for_all_namespaces(body, pretty=pretty)
...
try: 
    ...
    print("Exception when calling AppsV1Api->create_replica_set_for_all_namespaces: %s\n" % e)
```
...
# **create_stateful_set_for_all_namespaces**
> V1StatefulSet create_stateful_set_for_all_namespaces(body, pretty=pretty)
...
try: 
    api_response = api_instance.create_stateful_set_for_all_namespaces(body, pretty=pretty)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling AppsV1Api->create_stateful_set_for_all_namespaces: %s\n" % e)
```
...
> V1ControllerRevisionList list_controller_revision_for_all_namespaces(pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try: 
    api_response = api_instance.list_controller_revision_for_all_namespaces(pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
> V1DaemonSetList list_daemon_set_for_all_namespaces(pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try: 
    api_response = api_instance.list_daemon_set_for_all_namespaces(pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
> V1DeploymentList list_deployment_for_all_namespaces(pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try: 
    api_response = api_instance.list_deployment_for_all_namespaces(pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
> V1ReplicaSetList list_replica_set_for_all_namespaces(pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try: 
    api_response = api_instance.list_replica_set_for_all_namespaces(pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
> V1StatefulSetList list_stateful_set_for_all_namespaces(pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try: 
    api_response = api_instance.list_stateful_set_for_all_namespaces(pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
name = 'name_example' # str | name of the Scale
namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
body = openshift.client.V1Scale() # V1Scale | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
