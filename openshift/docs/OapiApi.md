...
[**generate_namespaced_deployment_config**](OapiApi.md#generate_namespaced_deployment_config) | **GET** /oapi/v1/namespaces/{namespace}/generatedeploymentconfigs/{name} | 
[**get_api_resources**](OapiApi.md#get_api_resources) | **GET** /oapi/v1/ | 
[**get_oapi_version**](OapiApi.md#get_oapi_version) | **GET** /oapi/ | 
...
try: 
    ...
    print("Exception when calling OapiApi->generate_namespaced_deployment_config: %s\n" % e)
```
...
try: 
    api_instance.get_oapi_version()
except ApiException as e:
    print("Exception when calling OapiApi->get_oapi_version: %s\n" % e)
```
