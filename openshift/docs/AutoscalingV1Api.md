# openshift.client.AutoscalingV1Api
...
api_instance = openshift.client.AutoscalingV1Api()
body = openshift.client.V1HorizontalPodAutoscaler() # V1HorizontalPodAutoscaler | 
...
> V1HorizontalPodAutoscalerList list_horizontal_pod_autoscaler_for_all_namespaces(pretty=pretty, field_selector=field_selector, label_selector=label_selector, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
