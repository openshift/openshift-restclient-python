...
**items** | [**list[V1BrokerTemplateInstance]**](V1BrokerTemplateInstance.md) | items is a list of BrokerTemplateInstances | 
...
**metadata** | [**V1ListMeta**](V1ListMeta.md) | Standard object metadata. | [optional] 
