...
def test_create_namespace(ansible_helper, create_tasks, obj_compare, create_namespace):
...
def test_get_namespace(ansible_helper, create_tasks):
    parameters = create_tasks['create']
    namespace = parameters.get('namespace')
...
def test_patch_namespace(ansible_helper, patch_tasks, obj_compare):
...
def test_replace_namespace(ansible_helper, replace_tasks, obj_compare):
...
def test_remove_namespace(ansible_helper, create_tasks):
    parameters = create_tasks['create']
    namespace = parameters.get('namespace')
